...
internal external fun __wasm_import_now(p0: Int): Unit

@WasmImport("wasi:clocks/wall-clock@0.2.9", "resolution")
internal external fun __wasm_import_resolution(p0: Int): Unit
...
internal external fun __wasm_import_now0(): Long

@WasmImport("wasi:clocks/monotonic-clock@0.2.9", "resolution")
internal external fun __wasm_import_resolution1(): Long
